...
fn_lengths = [[1., 1.], ## 1
              ...
              [1., 1., 1., 1., 1., 1.], ## 7
              [1., 1., 1., 2., 3., 5., 1., 3.]] ## 8
fn_kernels = ["matern", "matern", "rbf", "rbf",
              "rbf", "rbf", "matern", "rbf"]

ranking_new_guesses=False

for (f_number, grid_res, tune, atype, length_mod, kernel) in \
        zip(fn, fn_res, fn_tunes, fn_types, fn_lengths, fn_kernels):
